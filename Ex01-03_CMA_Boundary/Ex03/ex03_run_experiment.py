# Ex03: Запуск повного (експериментального) прогону
# Викликає ex03_run.py з опцією -n. Додатковий аргумент N (число) — кількість прогонів (напр. ex03_run_experiment.py 10).
